 ...
 *
 */
public class InsiemiCap1 extends Argomento {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		inserisciStacco();
		inserisciTesto("Come presto imparerai, in matematica siamo pigri. Non abbiamo molta voglia di scrivere. Ecco che una volta capito un concetto, dobbiamo imparare anche alcuni simboli che ci permettono di accorciare le frasi.");
		inserisciTesto("Immagina di dover scrivere ad esempio: la Toscana appartiene all'insieme delle regioni italiane, la Puglia appartiene all'insieme delle regioni italiane...non finiremmo più!");
		inserisciTesto("Dobbiamo inventarci qualcosa di furbo: ecco che ci vengono in aiuto una serie di convenzioni e simboli");
		inserisciTesto("Innanzitutto gli insiemi si indicano solitamente con una lettera maiuscola dell'alfabeto: A, B, C,...");
		inserisciTesto("Gli elementi di un insieme si indicano solitamente con una lettera minuscola dell'alfabeto: a, b, c, ....");
