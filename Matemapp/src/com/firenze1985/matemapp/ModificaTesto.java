...
public class ModificaTesto {
	 ...
	 * @param testo
	 */
	protected static void inserisciTesto(LinearLayout linear, TextView textView, String testo) {
	 ...
	 * @param testo
	 */
	protected static void inserisciTestoInGrassetto(LinearLayout linear, TextView textView, String testo) {
        textView.setText(testo);
	 ...
	 */
	protected static void inserisciTestoConParteInGrassetto(LinearLayout linear, TextView textView, String testo, int inizioBoldCompreso, int fineBoldEscluso) {
	 ...
	 * @param testo
	 */
	protected static void inserisciTitolo(LinearLayout linear, TextView textView, String testo) {
		textView.setText(testo);
	 ...
	 * @param isBold
	 */
	protected static void inserisciTestoGrandezzaPersonalizzata(LinearLayout linear, TextView textView, String testo,int tipoGrandezza, float grandezza, boolean isBold) {
		textView.setText(testo);
	 ...
	 * @param testo
	 */
	protected static void inserisciTitoloParagrafo(LinearLayout linear, TextView textView, String testo, int paddingTop){
	 ...
	 * @param testo
	 */
	protected static void inserisciTitoloParagrafo(LinearLayout linear, TextView textView, String testo) {
	 ...
	 */
	protected static void inserisciStacco(LinearLayout linear, TextView textView) {
	 ...
	 */
	protected static void inserisciTestoPersonalizzato(LinearLayout linear, TextView textView, String testo, 
	 ...
	 * @param testo
	 */
	protected static void inserisciTestoInCorsivo(LinearLayout linear, TextView textView, String testo) {
        textView.setText(testo);
        textView.setTypeface(null, Typeface.ITALIC);
        if (linear != null){
        	linear.addView(textView);
	 ...
	 * @param fineBoldEscluso
	 */
	protected static void inserisciTestoConParteInCorsivo(LinearLayout linear, TextView textView, String testo, int inizioCorsivoCompreso, int fineCorsivoEscluso) {
		SpannableStringBuilder str = new SpannableStringBuilder(testo);
		str.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.ITALIC), inizioCorsivoCompreso, fineCorsivoEscluso, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
		textView.setText(str);
        if (linear != null){
	 ...
	 * @param colore
	 */
	protected static void inserisciTestoColorato(LinearLayout linear, TextView textView, String testo, String colore) {
		textView.setText(testo);
	 ...
	 * @param testo
	 */
	protected static void inserisciDefinizione(LinearLayout linear, TextView textView, String testo, HashMap mappaPartiInGrassetto) {
		...
		inserisciStacco(linear, textView);
	 ...
	 */
	protected static void inserisciTestoConPiuPartiInGrassetto(LinearLayout linear, TextView textView, String testo, HashMap mappaPartiInGrassetto) {
		Iterator i = mappaPartiInGrassetto.entrySet().iterator();
		SpannableStringBuilder str = new SpannableStringBuilder(testo);
		while (i.hasNext()) {
	        Map.Entry mappa = (Map.Entry)i.next();
	 ...
	 * @param testo
	 */
	protected static void inserisciTestoConRiquadro(LinearLayout linear, TextView textView, String testo) {
	 ...
	 * @param colore
	 */
	protected static void inserisciTestoColoratoInGrassetto(LinearLayout linear, TextView textView, String testo, String colore) {
		textView.setText(testo);
        textView.setTypeface(null, Typeface.BOLD);
		textView.setTextColor(Color.parseColor(colore));
		if (linear != null){
	 ...
	 */
	protected static void inserisciTestoConRiquadroConclusivo(LinearLayout linear, TextView textView, String testo) {
    ...
    protected static void preparaTesto(LinearLayout linear, TextView textView, SpannableStringBuilder builder, String text, String textToBold, int tipologiaModifica){
    ...
    protected static void inserisciTestoPersonalizzato(LinearLayout linear, TextView textView, String testo, HashMap<String, Integer> mappaParolaModifica) {
